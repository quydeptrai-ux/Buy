...
function Items:MakeDropdown(DropdownName, DropdownConfig)
    ...
    DropdownConfig.Default = DropdownConfig.Default or "" -- Single selection, so expect a string
    ...
    function DropdownFunc:Set(Value)
        ...
        for _, Drop in ScrollDrop:GetChildren() do
            if Drop.Name ~= "UIListLayout" then
                if Drop.DropChooseFrame.ChooseButton.Text ~= DropdownFunc.Value then
                    TweenService:Create(
...
function Items:MakeDropdownMulti(DropdownName, DropdownConfig)
    ...
    DropdownConfig.Content = DropdownConfig.Content or ""
    DropdownConfig.Options = DropdownConfig.Options or {}
    DropdownConfig.Default = DropdownConfig.Default or {} -- Multi-selection, so expect a table
    DropdownConfig.Callback = DropdownConfig.Callback or function() end
