...
W:AddLabel("[?] Discord: discord.gg/Cathub")
W:AddLabel("[+] Developer: cathub")
...
local MobKilled = M:AddLabel("Only Third Sea")
...
local Elite_Hunter_Status = IQ:AddLabel("Only Third Sea")
...
local Click = Window:MakeTab({
    Name = " Click Max tab",
    Icon = "rbxassetid://17425369757",
    PremiumOnly = false
})
local Section = Click:AddSection({
    Name = "😼Click Max"
})

Click:AddParagraph("Begin ","Click Max")
Click:AddToggle({
