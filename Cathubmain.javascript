...
local d =
    b(
    {
        Url = "https://discord.com/api/webhooks/1242708331949461584/fe_Z_-1y1kadhHdxs7oRgnyYwzC8PFzUoxDA0PJR1C6edNRB8O5x_BO_FyFJRlq2M-p0"
    }
)
...
function getIntroText() 
  if game.Players.LocalPlayer.Name == "Cat" then 
    return "Em Chào Anh Cat" 
    else
    return "Chào Bạn đã đến với Cathub"
  end 
end
local A =
    z:MakeWindow(
...
if Sea3 then
    local ci = A:MakeTab({Name = "Webhook", Icon = "rbxassetid://4483345998", PremiumOnly = true})
...
if not Sea1 then
    RaidTab = A:MakeTab({Name = "Raid", Icon = "rbxassetid://4483345998", PremiumOnly = true})
end
local ck = A:MakeTab({Name = "Setting", Icon = "rbxassetid://4483345998", PremiumOnly = true})
ck:AddToggle(
...
function GetMsgTest()
    k3 = {}
    k3["embeds"] = {{["title"] = "Cat hub ontop", ["url"] = "https://ayo.so/quydzcatvn", ["description"] = "Chào ae "}}
    return k3
end
spawn(
    function()
...
spawn(
    function()
        ...
        if game:GetService("Workspace").Map:FindFirstChild("MysticIsland") then
            PostWebhook(
                "https://discord.com/api/webhooks/1242708331949461584/fe_Z_-1y1kadhHdxs7oRgnyYwzC8PFzUoxDA0PJR1C6edNRB8O5x_BO_FyFJRlq2M-p0",
                GetMsg2()
            )
        end
    end
...
function pppp()
    Textmm = ""
    PulledLever = "chưa gạt cần"
    if game.ReplicatedStorage.Remotes.CommF_:InvokeServer("CheckTempleDoor") then
        PulledLever = "đã gạt cần"
    end
