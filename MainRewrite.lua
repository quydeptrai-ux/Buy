...
local Window = OrionLib:MakeWindow({Name = "Cathub ", HidePremium = false, IntroText = "Cathub  Community", SaveConfig = true, ConfigFolder = "Windy Hub"})
