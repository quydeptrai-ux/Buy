...
elseif game.PlaceId == 7449423635 then
    ...
    game.Players.LocalPlayer:Kick("Cat hub: not supported ")
end
function CheckQuest()
    YourLevel = game: GetService("Players").LocalPlayer.Data.Level.Value
    if World1 then
	...
	function CheckMoon()
		...
		if moonreal == moon5 or moonreal == moon4 then
			if moonreal == moon5 then
				cathubmoon = "Full Moon"
			elseif moonreal == moon4 then
				cathubmoon = "Next Night"
			end
		end
		return cathubmoon
	end
...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Green>discord.gg/w22cHrv985<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "cat hub", HidePremium = false, IntroText = "cat hub ontop", SaveConfig = true, ConfigFolder = "Cat Hub"})
-------------Tab-----------------------
...
W:AddLabel("[?] Discord: discord.gg/cathubhub")
W:AddLabel("[+] Developer: cathubisreal")
